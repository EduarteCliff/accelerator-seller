                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h1 class="mc-toc-title" style="text-align: center;"><span style="font-size:42px"><span style="font-family:comic sans ms,marker felt-thin,arial,sans-serif"><strong>$!PASSWORD!$</strong></span></span></h1>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            Copyright All Rights Reserved (C)2018 @GreenHat
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
